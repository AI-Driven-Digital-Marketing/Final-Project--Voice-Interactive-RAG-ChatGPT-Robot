...
if 'chat_history' not in st.session_state:
    st.session_state['chat_history'] = [
        ''' My fellow Americans,and supporters:I'm Joe Biden, I extend to you my deepest respect and gratitude. It is through the participation and commitment of each and every one of you that our democracy continues to thrive. Regardless of our political leanings,
